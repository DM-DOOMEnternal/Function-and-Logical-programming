...
пр_таланты:- Таланты =[_,_,_,_],
           ...
           (   sprava_next([воронов,_],[_,певец],Таланты);
            ...
            %(   (sleva_next([_,писатель],[сахаров,_],Таланты);
            %    sprava_next([_,писатель],[сахаров,_],Таланты)),
            %(sleva_next([_,писатель],[воронов,_],Таланты);
            %    sprava_next([_,писатель],[воронов,_],Таланты))),
